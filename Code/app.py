...
try:
    ...
    print("Running in lightweight Vercel Mode:", e)
...
def get_pred_text_from_db(pred_class):
    # Arshad221b Sign Language MNIST mapping (chr(pred + 65))
...
if __name__ == '__main__':
    print("Starting Arshad221b Integrated Sign Language Web Server on http://localhost:5000")
